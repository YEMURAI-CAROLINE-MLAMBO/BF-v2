...
*   **Spectral Ambient Light Sensor (S-ALS) Array:** A distributed array of spectral sensors that captures directional light intensity, color temperature, and source vectors. This data enables real-time "Ambient Relighting" of 3D objects and performs gamut shifting via the Snapdragon NPU to maintain contrast in any environment (up to 100,000-lux).
